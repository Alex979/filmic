...
examples/horizon/    a sunset horizon hero, used to tune the library's defaults
...
- [ ] Controls panel
- [x] Horizon example: layout that scales like a placed photo, colors that vary along the horizon
