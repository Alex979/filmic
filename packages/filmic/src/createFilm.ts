...
export interface Film {
  ...
  /**
   * Move an element with the film each frame (weave and flicker), boil an
   * ink filter's noise and apply its halation glow. Takes over the element's
   * transform and filter, so use a wrapper. Returns a function that detaches
   * it.
   */
